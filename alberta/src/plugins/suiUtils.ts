...
import { SuiNetwork } from "./services/atomaPayment";

// This code is adapted from @elizaOS/eliza v0.1.9
// Source: https://github.com/elizaOS/eliza/blob/v0.1.9/packages/plugin-sui/src/utils.ts
...
export const getTransactionLink = (network: SuiNetwork, tx: string): string => {
    if (network === "mainnet") {
